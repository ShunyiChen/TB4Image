...
public class ContrastAdjusterWithoutGUI implements Runnable,
	...
	Thread thread;
	private static ContrastAdjusterWithoutGUI instance;
		
	int minSliderValue=-1, maxSliderValue=-1, brightnessValue=-1, contrastValue=-1;
	int sliderRange = 256;
	public boolean doAutoAdjust,doReset,doSet,doApplyLut;
	...
	public double defaultMin, defaultMax;
	int contrast, brightness;
	public boolean RGBImage;
	...
	public ContrastAdjusterWithoutGUI() {
	}
...
//				ContrastAdjusterNonGUI ca = instance;
...
//			}
		...
		instance = this;
		IJ.register(ContrastAdjusterWithoutGUI.class);
...
//		add(panel);
	...
	public void adjustBrightness222(ImagePlus imp, ImageProcessor ip, double bvalue) {
		double center = defaultMin + (defaultMax-defaultMin)*((sliderRange-bvalue)/sliderRange);
		double width = max-min;
		min = center - width/2.0;
		max = center + width/2.0;
	...
	public void adjustContrast(ImagePlus imp, ImageProcessor ip, int cvalue) {
		double slope;
	...
	public void adjustContrast222(ImagePlus imp, ImageProcessor ip, int cvalue) {
		double slope;
		double center = min + (max-min)/2.0;
		double range = defaultMax-defaultMin;
		double mid = sliderRange/2;
